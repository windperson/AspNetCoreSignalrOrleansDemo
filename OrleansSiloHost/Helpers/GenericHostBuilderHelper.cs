...
using OrleansSiloHost.TypedOptions;
using Serilog;

namespace OrleansSiloHost.Helpers
{
    public class GenericHostBuilderHelper
    {
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            new HostBuilder()
                ...
                .UseOrleans((context, siloBuilder) =>
                {
                    ...
                    }).ConfigureApplicationParts(parts => parts.AddApplicationPart(typeof(MessageServerGrain).Assembly).WithReferences());
